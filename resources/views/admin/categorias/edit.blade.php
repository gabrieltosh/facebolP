...
@section('contenido')     
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      {!!Form::model($categoria, ['route' => ['panel.categoria.update', $categoria],'class'=>'form-horizontal style-form','method'=>'PUT'])!!}
                            @include('tienda.parcial.errors') 
                      <h3 class="text-center"><i class="fa fa-user"></i> Edicion de Categoria</h3>
